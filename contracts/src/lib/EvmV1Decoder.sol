...
// VENDORED FILE — not authored by this project.
// Source: @gluwa/asc-contracts@0.2.1 /contracts/common/EvmV1Decoder.sol (MIT), itself adapted from
// gluwa/attestcoin-protocol-examples. Copied verbatim so the Attestcoin decoder used to read proven
// receipts is byte-identical to the one the protocol examples decode with. Do not edit; re-vendor to upgrade.
